...
public class NewMicronicTubeRecordGenerator extends DefaultGenericPlugin {
     ...
     * @throws ServerException
     */
    private boolean hasDuplicateBarcodesInData(List<String> micronicTubeBarcodesAlreadyInLims, List<String> newMicronicTubeBarcodes) throws ServerException, RemoteException {
        ...
        if (duplicatesInNewBarcodes.size() > 0) {
            ...
            logError(String.format("Following duplicate barcodes found in the uploaded file %s", convertListToString(duplicatesInNewBarcodes)));
            return true;
        }
        return false;
    }
