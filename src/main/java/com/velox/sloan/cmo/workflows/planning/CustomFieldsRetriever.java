...
public class CustomFieldsRetriever extends DefaultGenericPlugin {
     ...
     */
    private DataRecord getSampleParentWithDesiredChildRecord(DataRecord sample, String childDataType) throws IoError,
            RemoteException, NotFound, ServerException {
