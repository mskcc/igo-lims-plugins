...
public class PlateSampleVolumeImporter extends DefaultGenericPlugin {
     ...
     * @throws ServerException
     */
    private List<Map<String, Object>> getRecordsFromFile(List<String> fileData, Map<String, Integer> header) throws
     ...
     * @throws ServerException
     */
    private boolean fileDataHasDuplicateRecords(List<String> fileData, Map<String, Integer> header, String filename)
