...
public class DigitalPcrReportGenerator extends DefaultGenericPlugin {
    ...
    private List<String> gexReportHeaders = Arrays.asList("Assay", "Sample ID", "IGO ID", "Total Input (ng)", "Copies Gene", "Copies Ref", "Ratio ([Gene]/[Ref])", "Droplet Count Gene", "Droplet Count Ref", "Accepted Droplets");
