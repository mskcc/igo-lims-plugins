...
public class DigitalPcrReportGenerator extends DefaultGenericPlugin {
    ...
    private List<String> redReportHeaders = Arrays.asList("Assay", "Sample ID", "IGO ID", "Total Input (ng)", "Concentration Gene (Copies)", "Concentration Ref (Copies)", "Ratio ([Gene]/[Ref])", "Droplet Count Gene", "Droplet Count Ref", "Accepted Droplets");
