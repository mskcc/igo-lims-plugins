...
public class DigitalPcrResultsParser extends DefaultGenericPlugin {
     ...
     * @throws ServerException
     */
    private void mapHumanPercentageFromDdpcrResultsToDnaQcReport(List<DataRecord> savedRecords) throws IoError, RemoteException, ServerException, NotFound, InvalidValue {
     ...
     * @throws NotFound
     */
    private List<DataRecord> getQcReportRecords(DataRecord sample, String requestId) throws IoError, RemoteException, ServerException, NotFound {
