...
public class ActiveAdapterPlateMarker extends DefaultGenericPlugin {
     ...
     * @throws InvalidValue
     */
    private void setAdapterSetAsUsedAndDepleted(String indexType, Integer setId, String plateBarcode, List<DataRecord> indexAssignmentConfigs) throws NotFound, RemoteException, IoError, InvalidValue, ServerException {
        for (DataRecord record : indexAssignmentConfigs) {
