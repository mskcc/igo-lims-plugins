...
public class DigitalPcrResultsParserTests {
    ...
    public void calculateTotalDnaDetected_shouldReturnCorrectValue(){
        Double valueA = 4.0;
        Double valueB = 5.0;
        Double expectedResult = 0.05280000000000001;
    ...
    public void calculateTotalDnaDetected_shouldReturnValueIfDenominatorIsZero(){
        Double valueA = 4.0;
        Double valueB = 0.0;
        Double expectedResultA = 0.264;
        Double expectedResultB = 0.0;
        assertEquals(resultsProcessor.calculateTotalDnaDetected(valueA, valueB), expectedResultA);
        assertEquals(resultsProcessor.calculateTotalDnaDetected(valueB, valueA), expectedResultB);
    }
